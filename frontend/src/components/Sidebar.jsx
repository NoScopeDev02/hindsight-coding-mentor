...
import { BrainCircuit, Trash2, Loader2, Activity, Zap, BarChart3, AlertTriangle, Cpu, Target, Gauge, Layers, Plus, X, ChevronLeft, ChevronRight } from 'lucide-react';

const Sidebar = ({ facts, onClear, isRecalling, dimension, setDimension, dimensions, onAddDimension, onDeleteDimension, isOpen, setIsOpen }) => {
            ...
            <div className="flex flex-wrap gap-2">
              {dimensions.map(dim => (
                <div key={dim.id} className="relative group/dim">
                  <button
                    onClick={() => { setDimension(dim.id); if(window.innerWidth < 1024) setIsOpen(false); }}
